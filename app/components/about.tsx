export function About() {
  return (
    <>
      ...
      <p className="mb-4  leading-7 text-neutral-400  font-semibold">
        {`Since 2021, I have been working on hundreds of small to medium outsourced global projects. And since 2023, I have been working as a remote, part-time front-end developer at a US-based health tech company.`}
      </p>
      <p className="mb-4  leading-7 text-neutral-400 font-semibold">
